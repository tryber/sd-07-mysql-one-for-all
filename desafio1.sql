...
INSERT INTO
usuario (usuario_id, nome_usuario, idade, plano_id)
VALUES
  (1, "Thati", 23, 1),
  (2, "Cintia", 35, 3),
  (3, "Bill", 20, 2),
...
INSERT INTO
plano (plano_id, nome_plano, preco_plano)
VALUES
  (1, "gratuito", 0.00),
...
INSERT INTO
historico_reproducao (usuario_id, musica_id)
VALUES
  (1, 1),
  (1, 6),
  (1, 14),
...
INSERT INTO
seguidor (artista_id, usuario_id)
VALUES
  (1, 1),
  (1, 4),
  (2, 1),
...
INSERT INTO
artista (artista_id, nome_artista)
VALUES
  (1, "Freedie Shannon"),
  (2, "Lance Day"),
  (3, "Peter Strong"),
...
INSERT INTO
album (album_id, nome_album, artista_id)
VALUES
  (1, "Envious", 4),
  (2, "Exuberant", 4),
  (3, "Hallowed Steam", 3),
...
INSERT INTO
musica (musica_id, nome_musica, album_id)
VALUES
  (1, "Soul For Us", 1),
