...
INSERT INTO SpotifyClone.usuarios(nome, idade, planos_id)
VALUES ('Thati', '23', 1),('Cintia', 35, 2),('Bill', 20, 3), ('Roger', '45', 1);
INSERT INTO SpotifyClone.artistas(nome)
VALUES ('Walter Phoenix'), ('Peter Strong'), ('Lance Day'), ('Freedie Shannon');
INSERT INTO SpotifyClone.albums(nome, artistas_id)
VALUES('Envious', 1),('Exuberant',1),('Hallowed Steam',2), ('Incandescent',3), ('Temporary Culture',4);
INSERT INTO SpotifyClone.cancoes(albums_id, artistas_id, nome)
...
INSERT INTO SpotifyClone.seguindo_artistas(usuarios_id, artistas_id)
VALUES(1, 1), (1, 4), (1,3),(2,1),(2,3),(3,2),(3,1),(4,4);
INSERT INTO SpotifyClone.historico_reproducoes(usuarios_id, cancoes_id)
