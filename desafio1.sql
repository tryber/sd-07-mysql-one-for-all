...
signature_name VARCHAR(30) NOT NULL,
...
INSERT INTO signatures (signature_name, signature_price) VALUES
('gratuito', 0),
('familiar', 7.99),
('universitário', 5.99);

INSERT INTO users (user_name, user_age, signature_id) VALUES 
('Thati', 23, 1),
('Cintia', 35, 2),
('Bill', 20, 3),
('Roger', 45, 1);
...
INSERT INTO artists_following (user_id, artist_id) VALUES
(1,1),
(1,4),
(1,3),
(2,1),
